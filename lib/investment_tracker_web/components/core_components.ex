defmodule InvestmentTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InvestmentTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InvestmentTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
